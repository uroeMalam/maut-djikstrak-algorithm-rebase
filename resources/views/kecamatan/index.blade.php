              ...
              <table class="table table-flush text-center data-table">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th style="font-size: 13px;">Nama Kecamatan</th>
                    <th style="font-size: 13px;">Latitude</th>
                    <th style="font-size: 13px;">Longitude</th>
...
@push('page-scripts')
    ...
    $(document).ready(function () {
      ...
      var table = $('.data-table').DataTable({
        ...
        serverSide: true,
        rowId:"id",
        ajax: "{{ route('kecamatan_dataTable') }}",
        columns: [
      ...
      $(document).on('click', '#hapusData', function(e) {
        e.preventDefault();
        var url = "{{ route('kecamatan-delete') }}";
        var csrf= '{{ csrf_token() }}';
